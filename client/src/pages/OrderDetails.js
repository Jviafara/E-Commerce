    ...
    return loading ? (
        ...
        <div>
            ...
            <div className="w-full">
                <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-6xl text-left font-semibold my-2 lg:mb-8 ">
            ...
            <div className="flex gap-8 justify-between">
                <section className="max-w-2/3 shrink-0 flex flex-col gap-4 ">
                    <div
                        class="flex flex-col gap-4 p-6 bg-white border border-gray-200 rounded-lg shadow
